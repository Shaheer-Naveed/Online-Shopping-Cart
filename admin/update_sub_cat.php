...
if (isset($_POST['update'])) {
    ...
    $parent_c_name = $_POST['parent_cat_name'];
    $status = $_POST['cat_status'];

    $query = "UPDATE add_sub_category SET Parent_Category = '$parent_c_name',  Category = '$c_name', Status = '$status' WHERE id = $c_id";
    
    if (mysqli_query($conn, $query)) {
        // Set success message for SweetAlert
        $_SESSION['status'] = "Sub Category updated successfully!";
        $_SESSION['status_code'] = "success";
    } else {
        // Set error message for SweetAlert
        $_SESSION['status'] = "Error updating sub category.";
...
if (isset($_SESSION['status']) && isset($_SESSION['status_code'])) {
    ...
    <script>
        Swal.fire({
            ...
            window.location.href = 'view_sub_cat.php'; // Or any page you want to redirect to
        });
    </script>
    <?php
...
if (isset($_GET['edit'])) {
    $edit_id = $_GET['edit'];
    $query = "SELECT * FROM add_sub_category WHERE id = $edit_id";
...
<div class="mb-4 mt-4">
  <div class="card card-body p-3">
        <div class="white_card card_height_100 mb_30">
                <div class="white_card_header">
                    <div class="row">
                        <div class="col-md-10 main-title">
                            <h3 class="font-weight-bold">Update Sub Category</h3>
                        </div>
                ...
                <input type="text" class="form-control" name="parent_cat_name" value="<?php echo $cat['Parent_Category']; ?>" style="width:60%;">
